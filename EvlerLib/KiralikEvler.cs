...
namespace EvlerLib
{
    public class KiralikEvler : Evler
    {
        ...
        {
           StreamReader sr = File.OpenText("C:\\Users\\omert\\OneDrive\\Masaüstü\\Yazılım\\C# Derslerii\\EmlakciUygulamasi\\KiralikEvler.txt");
            return sr.ReadToEnd();
        ...
        {
            using (StreamWriter sw = new StreamWriter("C:\\Users\\omert\\OneDrive\\Masaüstü\\Yazılım\\C# Derslerii\\EmlakciUygulamasi\\KiralikEvler.txt"))
            {
